...
class Meteor:
    ...
    def compute_score(self, gts, res):
        ...
        for i in range(0,len(imgIds)):
            stuffing = self.meteor_p.stdout.readline().decode('utf-8').strip()
            scores.append(float(stuffing))
    ...
    def _stat(self, hypothesis_str, reference_list):
        ...
        #return self.meteor_p.communicate(input='{}\n'.format(score_line).encode('utf-8'))[0]
