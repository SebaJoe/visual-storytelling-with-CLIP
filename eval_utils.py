...
class Evaluator:
    ...
    def measure(self):
        ...
        for key in predictions.keys():
            new_reference[key] = self.reference[key]
        self.eval.evaluate(new_reference, predictions)
    ...
    def eval_story(self, model, crit, dataset, loader, opt, side_model=None):
        ...
        for iter, batch in enumerate(loader):
            ...
            copy_stories = copy.deepcopy(results).cpu()

            stories = utils.decode_story(dataset.get_vocab(), copy_stories.numpy(), during_training=True, during_eval=True)
    ...
    def test_story(self, model, dataset, loader, opt):
        ...
        for iter, batch in enumerate(loader):
            ...
            sents = utils.decode_story(dataset.get_vocab(), copy_stories.numpy(), during_training=True, during_eval=True)
